# One-off bootstrap: creates the S3 bucket + DynamoDB lock table that
# infra/terraform/aws/backend.tf's commented `backend "s3"` block points at.
#
...
# exactly once, by hand, against a real account:
#
...
# verification (see infra/terraform/README.md).
