...
func TestTranslateSlTp_NilMasterPrice_ReturnsNil(t *testing.T) {
	got := translateSlTp(nil, 1.1000, domain.TradeDirectionBuy, domain.TradeDirectionBuy, 0.0001, 0.0001, "SL")
	if got != nil {
...
func TestTranslateSlTp_ZeroPipSize_ReturnsNil(t *testing.T) {
	price := 1.0950
	if got := translateSlTp(&price, 1.1000, domain.TradeDirectionBuy, domain.TradeDirectionBuy, 0, 0.0001, "SL"); got != nil {
		t.Fatalf("expected nil for zero masterPipSize, got %v", *got)
	}
	if got := translateSlTp(&price, 1.1000, domain.TradeDirectionBuy, domain.TradeDirectionBuy, 0.0001, 0, "SL"); got != nil {
...
func TestTranslateSlTp_SAME_IdenticalPipSize_BuyPosition(t *testing.T) {
	...
	gotSL := translateSlTp(&masterSL, masterOpen, domain.TradeDirectionBuy, domain.TradeDirectionBuy, 0.0001, 0.0001, "SL")
	gotTP := translateSlTp(&masterTP, masterOpen, domain.TradeDirectionBuy, domain.TradeDirectionBuy, 0.0001, 0.0001, "TP")
...
func TestTranslateSlTp_SAME_DifferentPipSize_ScalesDistance(t *testing.T) {
	...
	got := translateSlTp(&masterSL, masterOpen, domain.TradeDirectionBuy, domain.TradeDirectionBuy, 0.0001, 0.01, "SL")
	// followerOpenPriceApprox (masterOpen) - followerSign*(50 pips * 0.01) = 1.1000 - 0.5 = 0.6000
	want := 0.6000
...
func TestTranslateSlTp_REVERSE_BuyMasterSellFollower_FlipsSide(t *testing.T) {
	...
	gotSL := translateSlTp(&masterSL, masterOpen, domain.TradeDirectionBuy, followerDirection, 0.0001, 0.0001, "SL")
	gotTP := translateSlTp(&masterTP, masterOpen, domain.TradeDirectionBuy, followerDirection, 0.0001, 0.0001, "TP")
...
func TestTranslateSlTp_REVERSE_SellMasterBuyFollower_FlipsSide(t *testing.T) {
	...
	gotSL := translateSlTp(&masterSL, masterOpen, domain.TradeDirectionSell, followerDirection, 0.0001, 0.0001, "SL")
	gotTP := translateSlTp(&masterTP, masterOpen, domain.TradeDirectionSell, followerDirection, 0.0001, 0.0001, "TP")
