  ...
  if (confirming) {
    return (
      <div className="flex flex-col items-start gap-1.5">
        <p className="max-w-[260px] text-[12px] text-[var(--text-2)]">
          Raise a dispute on this settlement? An admin will review the computation before
          it&rsquo;s resolved.
        </p>
        <div className="flex gap-2">
          ...
          >
            {pending ? "Raising…" : "Yes, raise dispute"}
          </button>
          <button
            type="button"
            disabled={pending}
