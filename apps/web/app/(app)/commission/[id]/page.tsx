...
/**
 * TICKET-117 follow-up — a Master's own settlement detail, same shape as
 * follower/commission/[id]/page.tsx (route-scoped duplication, not a cross-route import, matching
 * this app's established convention) — the underlying data/ownership model is identical, only the
 * caller is the master side of the copy_relationship instead of the follower side.
 */
export default async function MasterSettlementDetailPage({
  params,
}: {
