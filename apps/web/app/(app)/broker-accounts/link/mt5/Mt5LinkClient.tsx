    ...
    <div className="mx-auto flex min-h-[60vh] max-w-[420px] flex-col justify-center">
      ...
      <form onSubmit={submit} className="mt-6 flex flex-col gap-3.5">
        ...
        <label className="flex flex-col gap-1.5">
          <span className="text-[12.5px] font-medium text-[var(--text-2)]">Broker name</span>
          <input
            required
            value={brokerName}
...
export function Mt5LinkClient({ accountRole }: { accountRole: ConnectionRole }) {
  return (
    <Suspense fallback={null}>
      <ConnectMt5Form accountRole={accountRole} />
    </Suspense>
  );
}
