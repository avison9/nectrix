...
// system-preference-only, no manual override), and Two-factor authentication has no settings
// sub-page in apps/web yet — both render per the mock's layout but stay inert, same "rendered but
// inert" precedent app/masters/page.tsx already established for its own not-yet-wired button.
    ...
    <main className="mx-auto max-w-[760px] px-4 py-10">
      ...
      <div className="mb-4 rounded-2xl border border-[var(--border)] bg-[var(--surface)] px-5.5">
        ...
        <div className="flex items-center justify-between border-t border-[var(--border)] py-3.5">
          ...
          <span
            title="2FA settings aren't available on this page yet"
