 ...
 * establish for the Go services core-app calls into. {@code serviceToken} resolves the same
 * {@code INTERNAL_SERVICE_TOKEN} every other internal caller in this codebase already uses.
 */
