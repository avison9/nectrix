 ...
 * type from {@code invitations.domain.Invitation}, not a re-export of it (same convention as
 * {@code trading.api.CopyRelationshipView}). Carries only the fields
 * {@code trading}'s invitation-acceptance flow needs.
 */
